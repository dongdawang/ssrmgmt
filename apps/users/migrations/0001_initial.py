    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('none', 'none'), ('rc4', 'rc4'), ('rc4-md5', 'rc4-md5'), ('rc4-md5-6', 'rc4-md5-6'), ('aes-128-ctr', 'aes-128-ctr'), ('aes-192-ctr', 'aes-192-ctr'), ('aes-256-ctr', 'aes-256-ctr'), ('aes-128-cfb', 'aes-128-cfb'), ('aes-192-cfb', 'aes-192-cfb'), ('aes-128-cfb8', 'aes-128-cfb8'), ('aes-192-cfb8', 'aes-192-cfb8'), ('aes-256-cfb8', 'aes-256-cfb8')], default='none', max_length=30, verbose_name='加密方法')),
                ('protocol', models.CharField(choices=[('origin', 'origin'), ('auth_sha1_v4', 'auth_sha1_v4'), ('auth_aes128_md5', 'auth_aes128_md5'), ('auth_aes128_sha1', 'auth_aes128_sha1')], default='origin', max_length=30, verbose_name='协议')),
                ('obfs', models.CharField(choices=[('plain', 'plain'), ('http_simple', 'http_simple'), ('http_post', 'http_post'), ('tls1.2_ticket_auth', 'tls1.2_ticket_auth')], default='plain', max_length=30, verbose_name='混淆方法')),
                ('compatible', models.BooleanField(default=False, verbose_name='是否启用混淆')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('closed', 'closed'), ('open', 'open')], default='open', max_length=20, verbose_name='工单状态')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='ssr',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.SSRAccount', verbose_name='SSR账户'),
        ),
    ]
